...
var precedences = map[token.TokenType]int {
	token.EQ: EQUALS,			//Lower precedence
	token.NOT_EQ: EQUALS,
	...
	token.MINUS: SUM,
	token.SLASH: PRODUCT,
	token.ASTERISK: PRODUCT,	//Higher precedence
	token.LPAREN: CALL,	//Higher precedence
	token.LBRACKET: INDEX,		//Higher precedence
}
...
//generalised version of parseCallArguments() to reuse
